...
+ $$ E[(\bar{x}-\mu)^2] = E\left[\left(\frac{1}{N}\sum_{t=1}^{N} x(t) - \mu\right)^2\right] $$
...
$$ 
= \frac{1}{N-1} 
E \left\{ \sum_{t=1}^{N}(x(t)-\mu)^2 - N(\bar{x}-\mu)^2 \right\}
$$

$$ 
=\frac{1}{N-1} \cdot N\cdot \sigma^2 - \frac{N}{N-1} \cdot \frac{1}{N} \sigma^2 = \sigma^2
$$ 
...
[6] [Link to Zhihu article](https://zhuanlan.zhihu.com/p/35362151)

[7] [Link to another Zhihu article](https://zhuanlan.zhihu.com/p/36162561)
